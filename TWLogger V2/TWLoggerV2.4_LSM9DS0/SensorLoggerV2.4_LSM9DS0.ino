...
// ToDo 
// ADD millisecond and make retroactive 3.0 additions

////////////////////////////////////////////////////////////
#define vers "Version 2.4"
...
// Variable used to create fractions of seconds
// Subtract from tmstmp within a second to get milliseconds
uint32_t ms = 0;   
...
void writeHeader() {
  #ifdef Gyro_On
  logfile.println("Date(MM/DD/YYYY),Time(hh:mm:ss),MS,Timestamp(Ms),Temp(Raw),ACCELX,ACCELY,ACCELZ,MAGX,MAGY,MAGZ,GYRX,GYRY,GYRZ");
  #else
  logfile.println("Date(MM/DD/YYYY),Time(hh:mm:ss),MS,Timestamp(Ms),Temp(Raw),ACCELX,ACCELY,ACCELZ,MAGX,MAGY,MAGZ");
  #endif
}
...
void WriteToSD() {
  ...
  if(seconds != timekeeper) {
    ms = tmstmp; // reset at top of second for .000 
 ...
 // Formatting for file output mm/dd/yyyy, hh:mm:ss 
  ...
  logfile.print((tmstmp-ms)/1000); logfile.print(","); 
