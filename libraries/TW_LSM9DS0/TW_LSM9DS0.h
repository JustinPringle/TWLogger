...
/* by the TW_LSM9DS0::Sensor class to read and retrieve individual sensors. */
typedef void (TW_LSM9DS0::*lsm9ds0_read_func)(void);
typedef void (TW_LSM9DS0::*lsm9ds0_get_event_func)(sensors_event_t*, uint32_t);
typedef void (TW_LSM9DS0::*lsm9ds0_get_sensor_func)(sensor_t*);

class TW_LSM9DS0
{
  public:
    TW_LSM9DS0 ( int32_t sensorID = 0 );
    TW_LSM9DS0 ( TwoWire* wireBus, int32_t sensorID = 0 );
    TW_LSM9DS0 ( int8_t xmcs, int8_t gcs, int32_t sensorID = 0 );
    TW_LSM9DS0 ( int8_t clk, int8_t miso, int8_t mosi, int8_t xmcs, int8_t gcs, int32_t sensorID = 0 );
    ...
    typedef enum
    {
      ...
      LSM9DS0_REGISTER_CTRL_REG3_XM        = 0x22,
    ...
    public:
      ...
      {}
      Sensor(TW_LSM9DS0* parent, lsm9ds0_read_func readFunc, 
